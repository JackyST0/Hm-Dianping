...
### 1. 黑马点评项目介绍
- #### 项目介绍：
    - 本项目（黑马点评）是一个以社交平台为核心的轻电商项目。其主要围绕着 Redis 各种技术展开，并且项目中也包含了许多电商的业务场景，如短信登录、商户查询缓存、优惠劵秒杀、附近的商户、UV统计、用户签到、好友关注、达人探店等。可以说，此项目把 Redis 中各种各样的数据结构、各种各样的应用姿势“玩”了个遍。
- #### 项目内容：
    -  共享session登录问题
...
- ##### 反正不管，跟着新哥学就对了！！！
---
参考视频：[黑马点评](https://www.bilibili.com/video/BV1cr4y1671t?p=24&vd_source=a6541efd5c43d30c410c9e45054c9b89)